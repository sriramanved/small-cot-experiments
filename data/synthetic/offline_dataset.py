...
# Loader for fixed rendered datasets used by LogLossBC/SFT. Student-prefix
# methods read the prompt bank and query the teacher on current student
# prefixes instead. See `experiment_log.md`.
_CACHE = {}
_STATE = {}
